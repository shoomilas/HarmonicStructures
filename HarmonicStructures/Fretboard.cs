...
namespace HarmonicStructures
{
    ...
    partial class Fretboard
	{
		...
		private int NumberOfFrets { get; set; } = 12;
		private Pitch[,] fretboard;

		public Fretboard(params Pitch[] Tuning) //Constructor that assigns notes to frets on a guitar dynamically (accordingly to guitar's number of strings and tuning).
		{
